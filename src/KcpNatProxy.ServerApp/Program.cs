...
builder.Command.Description = "KcpNatProxy server.";
...
static async Task RunAsync(FileInfo config, bool verbose, bool trace, CancellationToken cancellationToken)
{
    ...
    IHostBuilder builder = Host.CreateDefaultBuilder()
        ...
        {
            services.Configure<KnpServerOptions>(hostContext.Configuration);
            services.AddHostedService<KnpServerHostedService>();
        })
        .UseSystemd();
